...
\date[Feb 13\textsuperscript{th} 2026]{Friday, February 13\textsuperscript{th} 2026}
...
\label{sec:org2f2069c}
\begin{frame}[label={sec:orgb56e413}]{Introduction to Unsupervised Learning}
\begin{definition}[What is Unsupervised Learning?]\label{sec:org9202d9f}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgdb32e40}]{Types of Unsupervised Learning}
...
\label{sec:org47c7319}
\begin{frame}[label={sec:orgf913ae3}]{Dimensionality Reduction}
...
\item \alert{Linear Discriminant Analysis (LDA)}: A supervised technique that finds a linear combination of features that separates two or more classes. (Included here for comparison; requires labels.)
...
\label{sec:orgf9e2e6b}
\begin{frame}[label={sec:orgdaac264}]{Principal Component Analysis (PCA)}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgfaab9df}]{Steps in PCA}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org46f652c}]{Applications of PCA}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgd8319bf}]{Limitations of PCA}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org1eb5ee7}]{Evaluating PCA Results}
...
\label{sec:org9242cbb}
\begin{frame}[label={sec:org9c98984}]{Autoencoders}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org85f82aa}]{Structure of Autoencoders}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgf12c362}]{Applications of Autoencoders}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org2d4a1f0}]{Limitations of Autoencoders}
...
\end{frame}
\section{Clustering}
\label{sec:orgd09f944}
\begin{frame}[label={sec:org3462e54}]{Clustering}
\begin{definition}[Clustering]\label{sec:org78cea45}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org2d45aa5}]{Types of Clustering Algorithms}
\begin{definition}[Types of Clustering Algorithms]\label{sec:org57f7871}
\pause
Based on their approach, clustering algorithms can be categorized into several types:
\begin{itemize}[<+->]
...
\item \alert{Density-Based Methods}: These algorithms group data points based on the density of data points in the feature space. DBSCAN (Density-Based Spatial Clustering of Applications with Noise) is a popular density-based clustering algorithm.
\item \alert{Model-Based Methods}: These algorithms assume that the data is generated from a mixture of underlying probability distributions. Gaussian Mixture Models (GMMs) are a common example, where each cluster is represented by a Gaussian distribution.
\end{itemize}
\end{definition}
\end{frame}
\section[k-Means]{k-Means Clustering}
\label{sec:orga774d9e}
\begin{frame}[label={sec:org396ab67}]{k-Means Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org9eba3d8}]{Steps in k-Means Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgf57c0d8}]{Applications of k-Means Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgd20a1af}]{Limitations of k-Means Clustering}
...
\label{sec:org1c3a6a2}
\begin{frame}[label={sec:org9ef3320}]{Hierarchical Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org1648d65}]{Types of Hierarchical Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org7fd81c9}]{Steps in Agglomerative Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org2b5c3ff}]{Applications of Hierarchical Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orged94729}]{Limitations of Hierarchical Clustering}
...
\label{sec:orgb2761af}
\begin{frame}[label={sec:org086416d}]{Anomaly Detection}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org2d38fa3}]{Types of Anomaly Detection Techniques}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgc21167a}]{Steps in Anomaly Detection}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga93eb69}]{Applications of Anomaly Detection}
