...
\label{sec:org9993b9d}
\begin{frame}[label={sec:org9d6d0dc}]{Introduction to Classification}
\begin{definition}[Classification]\label{sec:orgcf971c2}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgd9c072f}]{Classification Types}
\begin{definition}[Classification Types]\label{sec:org26bf358}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org198265a}]{Classification Algorithms}
\begin{definition}[Classification Algorithms]\label{sec:org9412dce}
\pause
...
\label{sec:org41a8533}
\begin{frame}[label={sec:org0857db5}]{Logistic Regression}
\begin{definition}[Logistic Regression]\label{sec:org69f4daf}
\pause
...
\label{sec:orgd466b6e}
\begin{frame}[label={sec:orge75a334}]{Evaluation Metrics for Classification}
\begin{definition}[Confusion Matrix]\label{sec:org86f4c91}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orga7a3aa9}]{Accuracy (Overall Success Rate)}
\begin{definition}[Accuracy (Overall Success Rate)]\label{sec:orgcbc3cb1}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org156f6eb}]{Precision (Positive Predictive Value)}
\begin{definition}[Precision (Positive Predictive Value)]\label{sec:orgf6ce79c}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org8f235de}]{Recall (Sensitivity, True-Positive Rate)}
\begin{definition}[Recall (Sensitivity, True-Positive Rate)]\label{sec:orgc2c7d49}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgb124172}]{F1-Score}
\begin{definition}[F1-Score]\label{sec:orgd351228}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgb8ec791}]{Precision-Recall Trade-off}
\begin{definition}[Precision-Recall Trade-off]\label{sec:org95bf111}
...
\end{itemize}
\end{definition}
\begin{definition}[Precision-Recall Curve]\label{sec:org21af355}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgf593ed5}]{Receiver Operating Characteristic (ROC) Curve}
\begin{definition}[Receiver Operating Characteristic (ROC) Curve]\label{sec:org00c40db}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgf906cfc}]{Area Under the Curve (AUC)}
\begin{definition}[Area Under the Curve (AUC)]\label{sec:orgf24a62f}
\pause
...
\label{sec:org72b68fc}
\begin{frame}[label={sec:org72775bc}]{\(k\)-Nearest Neighbours (\(k\)-NN)}
\begin{definition}[\(k\)-Nearest Neighbours (\(k\)-NN)]\label{sec:org64d1794}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org86d81cd}]{Mathematical Formulation}
\begin{definition}[Mathematical Formulation]\label{sec:org3bdf61e}
...
\label{sec:org7bd882a}
\begin{frame}[label={sec:orga9b492e}]{Decision Trees}
\begin{definition}[Decision Trees]\label{sec:orgda5a0dd}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org40f0832}]{Information Gain}
\begin{definition}[Information Gain]\label{sec:orgd6b2718}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgbdc2f9b}]{Considerations for Decision Trees}
\begin{definition}[Considerations for Decision Trees]\label{sec:org9631eb9}
\begin{itemize}[<+->]
