...
\label{sec:org2fa4749}
\begin{frame}[label={sec:orgf852ea6}]{Introduction to Unsupervised Learning}
\begin{definition}[What is Unsupervised Learning?]\label{sec:org85df3c1}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org168fa0b}]{Types of Unsupervised Learning}
...
\label{sec:org7653252}
\begin{frame}[label={sec:orga37e6ea}]{Dimensionality Reduction}
...
\label{sec:org44d81c5}
\begin{frame}[label={sec:org4a85a3d}]{Principal Component Analysis (PCA)}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org48c812e}]{Steps in PCA}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org1ee4c5d}]{Applications of PCA}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgb400125}]{Limitations of PCA}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgb25d77c}]{Evaluating PCA Results}
...
\label{sec:orgb510f7f}
\begin{frame}[label={sec:org46ac92b}]{Autoencoders}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgdf6cf00}]{Structure of Autoencoders}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org20bd30e}]{Applications of Autoencoders}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org4aaf2fc}]{Limitations of Autoencoders}
...
\end{frame}
\section{Clustering}
\label{sec:org1c93b91}
\begin{frame}[label={sec:orgf4bc492}]{Clustering}
\begin{definition}[Clustering]\label{sec:orgcaa973f}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org19996cb}]{Types of Clustering Algorithms}
\begin{definition}[Types of Clustering Algorithms]\label{sec:org4fac0dd}
\pause
...
\label{sec:org9bb3b62}
\begin{frame}[label={sec:orgd191eb8}]{k-Means Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgc6dbeac}]{Steps in k-Means Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org079459b}]{Applications of k-Means Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org7706c86}]{Limitations of k-Means Clustering}
...
\label{sec:org57591d5}
\begin{frame}[label={sec:org09a5dce}]{Hierarchical Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga4d3d5e}]{Types of Hierarchical Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga6e2303}]{Steps in Agglomerative Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgc3888f5}]{Applications of Hierarchical Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org428f45f}]{Limitations of Hierarchical Clustering}
