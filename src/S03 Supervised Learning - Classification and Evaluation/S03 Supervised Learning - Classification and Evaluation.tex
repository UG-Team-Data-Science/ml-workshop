...
\date[Feb 10\textsuperscript{th} 2026]{Tuesday, February 10\textsuperscript{th} 2026}
...
\label{sec:org4c9859a}
\begin{frame}[label={sec:org6bf8c32}]{Introduction to Classification}
\begin{definition}[Classification]\label{sec:org0aeb98a}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org376d488}]{Classification Types}
\begin{definition}[Classification Types]\label{sec:org366ed48}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org4712d97}]{Classification Algorithms}
\begin{definition}[Classification Algorithms]\label{sec:orga9d24b4}
\pause
...
\label{sec:orgd8633ed}
\begin{frame}[label={sec:orgf506433}]{Logistic Regression}
\begin{definition}[Logistic Regression]\label{sec:org77ddf0f}
\pause
...
\label{sec:orga3cae8f}
\begin{frame}[label={sec:org40dc808}]{Evaluation Metrics for Classification}
\begin{definition}[Confusion Matrix]\label{sec:orgf3e8829}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgca6fff8}]{Accuracy (Overall Success Rate)}
\begin{definition}[Accuracy (Overall Success Rate)]\label{sec:org4dcd815}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org9720f64}]{Precision (Positive Predictive Value)}
\begin{definition}[Precision (Positive Predictive Value)]\label{sec:org9d07415}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org557a036}]{Recall (Sensitivity, True-Positive Rate)}
\begin{definition}[Recall (Sensitivity, True-Positive Rate)]\label{sec:orgdc8c791}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org900b998}]{F1-Score}
\begin{definition}[F1-Score]\label{sec:org3ee87d8}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgb3e72ce}]{Precision-Recall Trade-off}
\begin{definition}[Precision-Recall Trade-off]\label{sec:org5b121b7}
...
\end{itemize}
\end{definition}
\begin{definition}[Precision-Recall Curve]\label{sec:org2facafb}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org38bcfe5}]{Receiver Operating Characteristic (ROC) Curve}
\begin{definition}[Receiver Operating Characteristic (ROC) Curve]\label{sec:orgbefa50e}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org7dae10a}]{Area Under the Curve (AUC)}
\begin{definition}[Area Under the Curve (AUC)]\label{sec:orgab1daf5}
\pause
...
\label{sec:orgf548f61}
\begin{frame}[label={sec:org7f9071e}]{\(k\)-Nearest Neighbours (\(k\)-NN)}
\begin{definition}[\(k\)-Nearest Neighbours (\(k\)-NN)]\label{sec:org17a2b02}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org0df85b7}]{Mathematical Formulation}
\begin{definition}[Mathematical Formulation]\label{sec:org523f7b3}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orga3865fd}]{Considerations for \(k\)-NN}
...
\label{sec:org7be8a6a}
\begin{frame}[label={sec:orgc18382f}]{Decision Trees}
\begin{definition}[Decision Trees]\label{sec:orge9feae0}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgf679c16}]{Information Gain}
\begin{definition}[Information Gain]\label{sec:org567fb33}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org38e82c5}]{Considerations for Decision Trees}
\begin{definition}[Considerations for Decision Trees]\label{sec:org54cdaa8}
\begin{itemize}[<+->]
...
\label{sec:orgfc3fbc3}
\begin{frame}[label={sec:org1879867}]{Support Vector Machines (SVM)}
\begin{definition}[Support Vector Machines (SVM)]\label{sec:org3a53caf}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org463df95}]{Linear SVMs}
\begin{definition}[Linear SVMs]\label{sec:orgf6e296c}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org8b04903}]{Non-Linear SVMs}
\begin{definition}[Non-Linear SVMs]\label{sec:orgbf896ce}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgc513788}]{Kernel Trick}
\begin{definition}[Kernel Trick]\label{sec:orged8a0c3}
