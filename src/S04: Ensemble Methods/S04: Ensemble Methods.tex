...
\label{sec:org02221cb}
\begin{frame}[label={sec:org8d0d78b}]{Introduction to Ensemble Methods}
\begin{definition}[What are Ensemble Methods?]\label{sec:org3a13339}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgde1ad03}]{Introduction to Ensemble Methods}
\begin{example}[Why Use Ensemble Methods?]\label{sec:orge985a98}
\begin{itemize}[<+->]
...
\end{example}
\end{frame}
\begin{frame}[label={sec:org3e98703}]{Types of Ensemble Methods}
\begin{example}[Ensamble Methods]\label{sec:orgd9cbea9}
\pause
...
\end{frame}
\section{Bagging}
\label{sec:orgcac3d2b}
\begin{frame}[label={sec:org59f9f8e}]{Bootstrap Aggregating (Bagging) Overview}
\begin{definition}[Bootstrap Aggregating (Bagging)]\label{sec:orgc1b769e}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgdf84127}]{Bagging and Random Forests}
\begin{example}[Bagging and Random Forests]\label{sec:orgd2d224c}
\pause
...
\end{example}
\end{frame}
\begin{frame}[label={sec:org43f6820}]{Feature Importance in Random Forests}
