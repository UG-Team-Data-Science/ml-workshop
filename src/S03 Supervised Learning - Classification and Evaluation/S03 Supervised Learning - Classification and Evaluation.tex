...
\label{sec:orgd9633ab}
\begin{frame}[label={sec:orga6fc109}]{Introduction to Classification}
\begin{definition}[Classification]\label{sec:orgc9ef722}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org38505ef}]{Classification Types}
\begin{definition}[Classification Types]\label{sec:org4a38c73}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgde053fd}]{Classification Algorithms}
\begin{definition}[Classification Algorithms]\label{sec:org51b9712}
\pause
...
\label{sec:org1299dfb}
\begin{frame}[label={sec:org5e16198}]{Logistic Regression}
\begin{definition}[Logistic Regression]\label{sec:org28f7f82}
\pause
...
\label{sec:org5e195ec}
\begin{frame}[label={sec:org79c547f}]{Evaluation Metrics for Classification}
\begin{definition}[Confusion Matrix]\label{sec:org2ce2ee1}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org5a4fff9}]{Accuracy (Overall Success Rate)}
\begin{definition}[Accuracy (Overall Success Rate)]\label{sec:org4a60261}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org587f3d2}]{Precision (Positive Predictive Value)}
\begin{definition}[Precision (Positive Predictive Value)]\label{sec:orgc7da7af}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgd5b10a2}]{Recall (Sensitivity, True-Positive Rate)}
\begin{definition}[Recall (Sensitivity, True-Positive Rate)]\label{sec:org64f96d9}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgd4d5710}]{F1-Score}
\begin{definition}[F1-Score]\label{sec:orga5ba869}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org9b08fde}]{Precision-Recall Trade-off}
\begin{definition}[Precision-Recall Trade-off]\label{sec:orgd8d2cee}
...
\end{itemize}
\end{definition}
\begin{definition}[Precision-Recall Curve]\label{sec:orgab37166}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org9bfe5f2}]{Receiver Operating Characteristic (ROC) Curve}
\begin{definition}[Receiver Operating Characteristic (ROC) Curve]\label{sec:org91171ab}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgad7ebc5}]{Area Under the Curve (AUC)}
\begin{definition}[Area Under the Curve (AUC)]\label{sec:org2325939}
\pause
...
\label{sec:org7ff66de}
\begin{frame}[label={sec:org2aa512a}]{\(k\)-Nearest Neighbours (\(k\)-NN)}
\begin{definition}[\(k\)-Nearest Neighbours (\(k\)-NN)]\label{sec:orgcf719d6}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org8ea0056}]{Mathematical Formulation}
\begin{definition}[Mathematical Formulation]\label{sec:orga7e09fa}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgd2b8339}]{Considerations for \(k\)-NN}
...
\label{sec:orgf28f0e6}
\begin{frame}[label={sec:orga977ef4}]{Decision Trees}
\begin{definition}[Decision Trees]\label{sec:org5df3a34}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org687cde3}]{Information Gain}
\begin{definition}[Information Gain]\label{sec:orgab1df6e}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgc8f7495}]{Considerations for Decision Trees}
\begin{definition}[Considerations for Decision Trees]\label{sec:orgc17aaa8}
\begin{itemize}[<+->]
...
\label{sec:org6321666}
\begin{frame}[label={sec:orga40162a}]{Support Vector Machines (SVM)}
\begin{definition}[Support Vector Machines (SVM)]\label{sec:orge52c844}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org5ec5c47}]{Linear SVMs}
\begin{definition}[Linear SVMs]\label{sec:orgf40ba85}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgf3635ff}]{Non-Linear SVMs}
\begin{definition}[Non-Linear SVMs]\label{sec:orge90af98}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orga97e919}]{Kernel Trick}
\begin{definition}[Kernel Trick]\label{sec:orga5dcc43}
