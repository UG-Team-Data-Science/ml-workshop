...
\label{sec:orged6a9f7}
\begin{frame}[label={sec:org6b1927d}]{Introduction to Regression}
\begin{definition}[Regression]\label{sec:org762680b}
\pause
...
\label{sec:orgfb00269}
\begin{frame}[label={sec:org52fb825}]{Simple Linear Regression}
\begin{definition}[Simple Linear Regression]\label{sec:orgca6daa0}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org917409d}]{Simple Linear Regression}
...
\end{frame}
\begin{frame}[label={sec:orgfb99e7d}]{Assumptions of Simple Linear Regression}
\begin{itemize}[<+->]
...
\label{sec:orga0f8934}
\begin{frame}[label={sec:org3adfd86}]{Evaluation Metrics for Regression}
\begin{definition}[Common Metrics for Regression]\label{sec:orge65a72a}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org90fd26d}]{Mean Absolute Error (MAE)}
\begin{definition}[Mean Absolute Error (MAE)]\label{sec:orgeb2e92d}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org4fb08d5}]{Mean Squared Error (MSE)}
\begin{definition}[Mean Squared Error (MSE)]\label{sec:orge7b0e78}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgd850ab0}]{Root Mean Squared Error (RMSE)}
\begin{definition}[Root Mean Squared Error (RMSE)]\label{sec:org7b318b8}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org79ba332}]{R-squared (\(R^2\))}
\begin{definition}[R-squared (\(R^2\))]\label{sec:orgbb57536}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orga45f723}]{Adjusted R-squared}
\begin{definition}[Adjusted R-squared]\label{sec:orgaf103c7}
\pause
...
\label{sec:org91035e8}
\begin{frame}[label={sec:orge23eb2e}]{Regression Diagnostics}
\begin{definition}[Regression Diagnostics]\label{sec:org6960cf4}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgacd5959}]{Key Diagnostic Checks}
\begin{definition}[Key Diagnostic Checks]\label{sec:org165f384}
\pause
\begin{itemize}[<+->]
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org34568f7}]{Residual Plot}
\begin{definition}[Residual Plot]\label{sec:org0f80518}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgd70c460}]{Q-Q Plot (Normality Check)}
\begin{definition}[Q-Q Plot]\label{sec:org90d3ead}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org39f4290}]{Influential Points (Cook's Distance)}
\begin{definition}[Cook's Distance]\label{sec:orge5dbce2}
\pause
...
\label{sec:orga3c7d0d}
\begin{frame}[label={sec:orgb60cc7d}]{Multiple Linear Regression}
\begin{definition}[Multiple Linear Regression]\label{sec:org3c215ea}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org700e4bc}]{Assumptions of Multiple Linear Regression}
\begin{definition}[Assumptions of Multiple Linear Regression]\label{sec:org64dc7af}
\pause
...
\label{sec:orgc15ca4b}
\begin{frame}[label={sec:org087d73b}]{How do Machine Learning Models Learn?}
\begin{definition}[How do Machine Learning Models Learn?]\label{sec:orgdebeb90}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org889e11c}]{Cost Function}
\begin{definition}[Cost Function]\label{sec:org4ddcbd2}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org6236599}]{Cost Function: Mean Squared Error (MSE)}
\begin{definition}[Cost Function: Mean Squared Error (MSE)]\label{sec:org8c5f5cd}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgb2843fb}]{Cost Function: Mean Absolute Error (MAE)}
\begin{definition}[Cost Function: Mean Absolute Error (MAE)]\label{sec:org35c2d51}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgc1a5f1c}]{Gradient Descent}
\begin{definition}[Gradient Descent]\label{sec:orgd119251}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgdd8ec35}]{Gradient Descent Algorithm}
\begin{definition}[Gradient Descent Algorithm]\label{sec:org6cbf71f}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgd4705a1}]{Overfitting and Underfitting}
\begin{definition}[Overfitting and Underfitting]\label{sec:orgceddfb7}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgbd60243}]{Regularization}
\begin{definition}[Regularization]\label{sec:orgcc9440a}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgb9a23e1}]{Types of Regularized Regression}
\begin{definition}[Types of Regularized Regression]\label{sec:orgff4c053}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgd23f2fa}]{Lasso Regression (L1 Regularization)}
\begin{definition}[Lasso Regression (L1 Regularization)]\label{sec:org79c3126}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orge185f78}]{Ridge Regression (L2 Regularization)}
\begin{definition}[Ridge Regression (L2 Regularization)]\label{sec:org74204ab}
\pause
...
\label{sec:orgb900328}
\begin{frame}[label={sec:orge433515}]{Nonlinearities in Regression}
\begin{definition}[Nonlinearities in Regression]\label{sec:orgda6c12e}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgddf6a28}]{Types of Nonlinear Regression Models}
\begin{definition}[Types of Nonlinear Regression Models]\label{sec:orgb627b15}
...
\label{sec:orgda7dfc8}
\begin{frame}[label={sec:org6bb2f59}]{Overfitting, Underfitting, and Hyperparameter Tuning}
\begin{definition}[Overfitting]\label{sec:orgdd52bf8}
\pause
\alert{Overfitting} occurs when a model learns the noise in the training data instead of the underlying pattern, resulting in poor generalization to unseen data. It typically happens when the model is too complex relative to the amount of training data.
\end{definition}
\end{frame}
\begin{frame}[label={sec:org22a49c4}]{Underfitting}
\begin{definition}[Underfitting]\label{sec:org92273ab}
\pause
\alert{Underfitting} occurs when a model is too simple to capture the underlying pattern in the data, resulting in poor performance on both training and unseen data. It typically happens when the model is not complex enough relative to the data.
\end{definition}
\end{frame}
\begin{frame}[label={sec:org7c30f75}]{Bias-Variance Tradeoff}
\begin{definition}[Bias-Variance Tradeoff]\label{sec:org2ffffd4}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgbe2a44d}]{Learning Curves}
\begin{definition}[Learning Curves]\label{sec:org8c67211}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org68e0231}]{Hyperparameter Tuning}
\begin{definition}[Hyperparameter Tuning]\label{sec:org62672c3}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org3e74da0}]{Techniques for Hyperparameter Tuning}
\begin{definition}[Techniques for Hyperparameter Tuning]\label{sec:org9fa8330}
