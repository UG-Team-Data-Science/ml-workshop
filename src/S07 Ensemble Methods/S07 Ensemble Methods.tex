...
\label{sec:orgdd4cc1a}
\begin{frame}[label={sec:orgd3c9814}]{Introduction to Ensemble Methods}
\begin{definition}[What are Ensemble Methods?]\label{sec:org4d82927}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org9d2d1dc}]{Introduction to Ensemble Methods}
\begin{example}[Why Use Ensemble Methods?]\label{sec:orgdebd7b0}
\begin{itemize}[<+->]
...
\end{example}
\end{frame}
\begin{frame}[label={sec:org9aa9704}]{Types of Ensemble Methods}
\begin{example}[Ensamble Methods]\label{sec:org51be7fb}
\pause
...
\end{frame}
\section{Bagging}
\label{sec:org3283af6}
\begin{frame}[label={sec:org0a460c7}]{Bootstrap Aggregating (Bagging) Overview}
\begin{definition}[Bootstrap Aggregating (Bagging)]\label{sec:orgc54c15b}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgc528114}]{Bagging and Random Forests}
\begin{example}[Bagging and Random Forests]\label{sec:orgea4fe43}
\pause
...
\end{example}
\end{frame}
\begin{frame}[label={sec:orga477a0f}]{Feature Importance in Random Forests}
...
\end{frame}
\section{Boosting}
\label{sec:org8129ea8}
\begin{frame}[label={sec:orgf9bc8ce}]{Boosting Overview}
\begin{definition}[Boosting Overview]\label{sec:orgafea492}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org38d7850}]{Boosting Algorithms}
\begin{example}[Boosting Algorithms]\label{sec:orgc70b3ea}
\pause
...
\label{sec:orge8c199f}
\begin{frame}[label={sec:orgd10a7b7}]{Ensembles of Ensemble Methods}
\begin{definition}[Ensembles of Ensemble Methods]\label{sec:org20f3226}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgad0ecd5}]{Ensembles of Ensemble Methods}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org023a6ac}]{Ensambles of Ensemble Methods}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org9848d19}]{Ensembles of Ensemble Methods}
