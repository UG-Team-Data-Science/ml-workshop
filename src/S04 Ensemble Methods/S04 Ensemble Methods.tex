...
\label{sec:org4327108}
\begin{frame}[label={sec:org8744463}]{Introduction to Ensemble Methods}
\begin{definition}[What are Ensemble Methods?]\label{sec:orge113d8f}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org12e4d99}]{Introduction to Ensemble Methods}
\begin{example}[Why Use Ensemble Methods?]\label{sec:org4e96a08}
\begin{itemize}[<+->]
...
\end{example}
\end{frame}
\begin{frame}[label={sec:org10095c7}]{Types of Ensemble Methods}
\begin{example}[Ensamble Methods]\label{sec:org052163c}
\pause
...
\end{frame}
\section{Bagging}
\label{sec:org795c22b}
\begin{frame}[label={sec:orgae19f28}]{Bootstrap Aggregating (Bagging) Overview}
\begin{definition}[Bootstrap Aggregating (Bagging)]\label{sec:org8cc6443}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org8f97050}]{Bagging and Random Forests}
\begin{example}[Bagging and Random Forests]\label{sec:org719283d}
\pause
...
\end{example}
\end{frame}
\begin{frame}[label={sec:org3349700}]{Feature Importance in Random Forests}
...
\end{frame}
\section{Boosting}
\label{sec:org8f3aea0}
\begin{frame}[label={sec:org5159cbf}]{Boosting Overview}
\begin{definition}[Boosting Overview]\label{sec:org149cc5f}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgb244f70}]{Boosting Algorithms}
\begin{example}[Boosting Algorithms]\label{sec:org4dec2ff}
\pause
...
\label{sec:org3dabaac}
\begin{frame}[label={sec:orga4f394f}]{Ensembles of Ensemble Methods}
\begin{example}[Ensembles of Ensemble Methods]\label{sec:org2c56461}
\pause
...
\end{example}
\end{frame}
\begin{frame}[label={sec:org51f3abb}]{Ensembles of Ensemble Methods}
