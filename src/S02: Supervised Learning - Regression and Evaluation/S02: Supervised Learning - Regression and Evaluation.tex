...
\label{sec:org5ce53af}
\begin{frame}[label={sec:org2a69da7}]{Introduction to Regression}
\begin{definition}[Regression]\label{sec:orgb3b7ee0}
\pause
...
\label{sec:org5911461}
\begin{frame}[label={sec:org69689e5}]{Simple Linear Regression}
\begin{definition}[Simple Linear Regression]\label{sec:orgb903274}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org18058b7}]{Simple Linear Regression}
...
\end{frame}
\begin{frame}[label={sec:org03bab50}]{Assumptions of Simple Linear Regression}
\begin{itemize}[<+->]
...
\label{sec:org8ac642b}
\begin{frame}[label={sec:orgb0655d7}]{Evaluation Metrics for Regression}
\begin{definition}[Common Metrics for Regression]\label{sec:orgaf1c827}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org8cbac41}]{Mean Absolute Error (MAE)}
\begin{definition}[Mean Absolute Error (MAE)]\label{sec:orgf4bae69}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orge67d95c}]{Mean Squared Error (MSE)}
\begin{definition}[Mean Squared Error (MSE)]\label{sec:org1af2e8c}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org7e535a3}]{Root Mean Squared Error (RMSE)}
\begin{definition}[Root Mean Squared Error (RMSE)]\label{sec:orge432062}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org8842e54}]{R-squared (\(R^2\))}
\begin{definition}[R-squared (\(R^2\))]\label{sec:org545e782}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgb228a49}]{Adjusted R-squared}
\begin{definition}[Adjusted R-squared]\label{sec:org07a8a3a}
\pause
...
\label{sec:orgc6d666d}
\begin{frame}[label={sec:org6e6c563}]{Robust Regression}
\begin{definition}[Robust Regression]\label{sec:org03ffc22}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgeff24ed}]{Types of Robust Regression}
\begin{definition}[Types of Robust Regression]\label{sec:org7c087f6}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org7d3be92}]{Huber Regression}
\begin{definition}[Huber Regression]\label{sec:org7a3a861}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgad50251}]{RANSAC (RANdom SAmple Consensus)}
\begin{definition}[RANSAC (RANdom SAmple Consensus)]\label{sec:org80f02e9}
\pause
...
\label{sec:org2b05700}
\begin{frame}[label={sec:org3086fb4}]{Multiple Linear Regression}
\begin{definition}[Multiple Linear Regression]\label{sec:orge67d03f}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgca84c97}]{Assumptions of Multiple Linear Regression}
\begin{definition}[Assumptions of Multiple Linear Regression]\label{sec:orge9d0a4d}
\pause
...
\label{sec:org53f4739}
\begin{frame}[label={sec:orgbb7884b}]{How do Machine Learning Models Learn?}
\begin{definition}[How do Machine Learning Models Learn?]\label{sec:org380823f}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org40e3e0f}]{Cost Function}
\begin{definition}[Cost Function]\label{sec:org3ef2002}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orgcee65b8}]{Cost Function: Mean Squared Error (MSE)}
\begin{definition}[Cost Function: Mean Squared Error (MSE)]\label{sec:org42f6fe1}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org2e546a3}]{Cost Function: Mean Absolute Error (MAE)}
\begin{definition}[Cost Function: Mean Absolute Error (MAE)]\label{sec:org2629c96}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org8b2790c}]{Gradient Descent}
\begin{definition}[Gradient Descent]\label{sec:orgc342803}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org768217b}]{Gradient Descent Algorithm}
\begin{definition}[Gradient Descent Algorithm]\label{sec:org302e2ad}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org7b24f6a}]{Overfitting and Underfitting}
\begin{definition}[Overfitting and Underfitting]\label{sec:org062b7c1}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org431c5e7}]{Regularization}
\begin{definition}[Regularization]\label{sec:org0a8eae0}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org7648e32}]{Types of Regularized Regression}
\begin{definition}[Types of Regularized Regression]\label{sec:orga7edb3f}
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orga75924e}]{Lasso Regression (L1 Regularization)}
\begin{definition}[Lasso Regression (L1 Regularization)]\label{sec:org01d100c}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orga9d3d5b}]{Ridge Regression (L2 Regularization)}
\begin{definition}[Ridge Regression (L2 Regularization)]\label{sec:orgf869a09}
\pause
