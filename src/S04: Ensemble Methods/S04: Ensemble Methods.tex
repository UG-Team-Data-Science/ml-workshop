...
\label{sec:orgf845916}
\begin{frame}[label={sec:org314801c}]{Introduction to Ensemble Methods}
\begin{definition}[What are Ensemble Methods?]\label{sec:orge9c1ea2}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orge8a3288}]{Introduction to Ensemble Methods}
\begin{example}[Why Use Ensemble Methods?]\label{sec:orga0744fd}
\begin{itemize}[<+->]
...
\end{example}
\end{frame}
\begin{frame}[label={sec:orgffb6085}]{Types of Ensemble Methods}
\begin{example}[Ensamble Methods]\label{sec:orgcd3d9d4}
\pause
...
\end{frame}
\section{Bagging}
\label{sec:org12beb2b}
\begin{frame}[label={sec:org53162a6}]{Bootstrap Aggregating (Bagging) Overview}
\begin{definition}[Bootstrap Aggregating (Bagging)]\label{sec:orgc31b411}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org8fb1359}]{Bagging and Random Forests}
\begin{example}[Bagging and Random Forests]\label{sec:org84b3204}
\pause
...
\end{example}
\end{frame}
\begin{frame}[label={sec:orgab3b075}]{Feature Importance in Random Forests}
