...
\label{sec:orgf2b4881}
\begin{frame}[label={sec:orgd844173}]{Introduction to Classification}
\begin{definition}[Classification]\label{sec:org02b395d}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:orga72cfd2}]{Classification Types}
\begin{definition}[Classification Types]\label{sec:orga0319d6}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org37557ed}]{Classification Algorithms}
\begin{definition}[Classification Algorithms]\label{sec:orgf21c290}
\pause
...
\label{sec:orgee77916}
\begin{frame}[label={sec:orgaf9fb53}]{Logistic Regression}
\begin{definition}[Logistic Regression]\label{sec:org341a9c6}
\pause
