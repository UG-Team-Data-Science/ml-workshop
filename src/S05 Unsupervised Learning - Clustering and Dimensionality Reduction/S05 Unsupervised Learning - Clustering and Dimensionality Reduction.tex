...
\label{sec:orgd1f1aa4}
\begin{frame}[label={sec:org6106dd5}]{Introduction to Unsupervised Learning}
\begin{definition}[What is Unsupervised Learning?]\label{sec:org9517bd2}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org41e0774}]{Types of Unsupervised Learning}
...
\label{sec:org2951842}
\begin{frame}[label={sec:org6570fb6}]{Dimensionality Reduction}
...
\label{sec:orgde6d011}
\begin{frame}[label={sec:orgf9208a1}]{Principal Component Analysis (PCA)}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org021dee3}]{Steps in PCA}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org60fc408}]{Applications of PCA}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgc770a63}]{Limitations of PCA}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org433b46a}]{Evaluating PCA Results}
...
\label{sec:org614c783}
\begin{frame}[label={sec:orge36fdd7}]{Autoencoders}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org9416521}]{Structure of Autoencoders}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orge9201cf}]{Applications of Autoencoders}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgd2be4e7}]{Limitations of Autoencoders}
...
\end{frame}
\section{Clustering}
\label{sec:orgb99485d}
\begin{frame}[label={sec:org336e3b9}]{Clustering}
\begin{definition}[Clustering]\label{sec:org7bbeae2}
\pause
...
\end{definition}
\end{frame}
\begin{frame}[label={sec:org6b4b07b}]{Types of Clustering Algorithms}
\begin{definition}[Types of Clustering Algorithms]\label{sec:orgced5e74}
\pause
...
\label{sec:org6f0f6af}
\begin{frame}[label={sec:org2a055da}]{k-Means Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org790d286}]{Steps in k-Means Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org3d76709}]{Applications of k-Means Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org7148f55}]{Limitations of k-Means Clustering}
...
\label{sec:org809b4a4}
\begin{frame}[label={sec:org8b111a6}]{Hierarchical Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgf10e889}]{Types of Hierarchical Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orge52eeb1}]{Steps in Agglomerative Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org8fa1a05}]{Applications of Hierarchical Clustering}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0dd86af}]{Limitations of Hierarchical Clustering}
